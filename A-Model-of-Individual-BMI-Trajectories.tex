...
\begin{figure}[!h]
\centering
\includegraphics[width=0.92\textwidth] {"Figures/Population-Level-Distribution-Parameters.pdf"}
\vspace*{-6pt}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.93\textwidth] {"Figures/Covariance-By-Time-Difference.pdf"}
\vspace{-1mm}
