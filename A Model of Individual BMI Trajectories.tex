...
% Future BMI distributions are then the simple summation of those individual trajectories at different points in time.

% The longitudinal data we use could, in principle, be used to estimate both a ppulation level distribution and a historical trend of BMI. However, we do not want to make the assumption that these data are representative of the Dutch population. We trust the Gezondheidsmonitor and VZinfo data ... . As a consequence, when transforming the longitufinal BMI values to z-scores, 
...
\vspace{-4mm}
% Figure 7: Colour purple renders text (numbers) hard to distinguish.
