...
Throughout the document, we will limit the output in each step. This is because the Doetinchem data are not open access. To request access to the data, please visit [www.rivm.nl/doetinchem-cohort-studie](https://www.rivm.nl/doetinchem-cohort-studie).
...
generated.bmi.trajectories.for.males.with.medium.education <- bmi.trajectory.parameters %>%
  ...
  mutate(
    age = 18 + time,
    mu = mu.education.M + mu.age.1 * age + mu.age.2 * age ^ 2,
    sigma = sigma.education.M + sigma.age.1 * age + sigma.age.2 * age ^ 2,
