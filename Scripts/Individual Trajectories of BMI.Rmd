...
population.level.distribution.parameters <- read_csv(
  file = "Population Level Distribution and Historical Trend of BMI.csv",
  col_type = cols(
    "sex" = col_factor(),
    .default = col_double()
  )
) %>%
  select(-contains("year")) # TODO: GitHub aanpassen
population.level.distribution.parameters
```
...
historical.trend.parameters <- read_csv(
  ...
  select(sex, contains("year")) # TODO: GitHub aanpassen
historical.trend.parameters
```
...
write_csv(
  bmi.trajectory.parameters,
  "Individual Trajectories of BMI.csv"
)
```
