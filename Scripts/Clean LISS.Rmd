...
ggplot(
  ...
  scale_fill_discrete(name = "Participating") +
  theme_void() +
  theme(
...
Finally, let's examine how large a change in BMI the participants experience over the 14 waves. This, too, may be visualised in a density plot.
